...
//        System.out.println(sourceIds);
    ...
    private static void insertBlockTextIntoResult(Question question, HashMap<String, String> questionMap) {
    ...
    private static void insertImageUrlIntoText(QuestionBlock block, StringBuilder text) {
        if(text.isEmpty()){
            return;
        }
